...
client.on('message', message => { // When the message a message is executed
    ...
    if (!(message.author.bot) && (message.content === 'f' || message.content === 'F')) { // if that message matches ping
    ...
    if (!(message.author.bot) && message.content.toLowerCase().includes('oof')) { // if that message matches ping
    ...
    if (!(message.author.bot) && message.content.toLowerCase().includes('fortnite bad')) { // if that message matches ping
    ...
    if (!(message.author.bot) && (message.content.toLowerCase().includes('war') || message.content.toLowerCase().includes('violence'))) { // if that message matches ping
   ...
   if (!(message.author.bot) && message.content.toLowerCase() === ('k')) { // if that message matches ping
   ...
   if (!(message.author.bot) && (message.content.toLowerCase().includes('torture') || message.content.toLowerCase().includes('cock and ball') || message.content.toLowerCase().includes('cbt'))) { // if that message matches ping
    ...
    if (!(message.author.bot) && message.content.toLowerCase().includes('shuckle')) { // if that message matches ping
    ...
    if (!(message.author.bot) && (message.content.toLowerCase().includes('deod') || message.content.toLowerCase().includes('deoxys-defense') || message.content.toLowerCase().includes('deoxys defense'))) { // if that message matches ping
    ...
    if (!(message.author.bot) && (message.content.toLowerCase().includes('uturn') || message.content.toLowerCase().includes('u-turn'))) { // if that message matches ping
